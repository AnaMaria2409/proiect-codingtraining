...
$rank=$op->getRank($id);
$solved=$op->getNumberofAnswers($id);
...
if($op->db->checkAnswerExistence($id,$_GET["id"])!=1){
	$op->db->incrementVizualizari($_GET["id"]);
...
<div class="questionBody">
	...
	<div class="details"><img src="solved.png" height="40" alt><?php echo $solved;?></div>
	<div class="details"><img src="view.png" height="40" alt><?php echo $continut["vizualizare"];?></div>
	<div class="details"><img src="star.png" height="40" alt><?php echo $rank;?></div>
...
<div class="questionForm">
	...
	<textarea  onfocus="this.value="";" rows="10" cols="100" name="answer" form="form"></textarea>
...
if($op->db->checkAnswerExistence($id,$_GET["id"])==1){
	...
	echo "<div class='question'>Solutia ta :".$op->getAnswer($id,$_GET["id"])."</div></br>";
		echo "<div class='question'>Solutia autorului :".$op->getSolutie($id)."</div></br>";
...
$x=sizeof($answers);
if($x==0){echo "<div class='congrat'>no answers</div>";}
